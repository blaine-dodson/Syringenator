...
Robert Gutmann, Ph.\+D.
\end{DoxyAuthor}
\hypertarget{autotoc_md4_autotoc_md5}{}\subsection{Terminology}\label{autotoc_md4_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{autotoc_md4_autotoc_md6}{}\subsection{Rules of the Game}\label{autotoc_md4_autotoc_md6}
