\hypertarget{Syringenator_8hpp}{}\subsection{src/\+Syringenator.hpp File Reference}
\label{Syringenator_8hpp}\index{src/Syringenator.hpp@{src/Syringenator.hpp}}


Arduino controller code.  


{\ttfamily \#include \char`\"{}constants.\+py\char`\"{}}\newline
Include dependency graph for Syringenator.\+hpp\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=187pt]{Syringenator_8hpp__incl}
\end{center}
\end{figure}
...
\index{Syringenator.hpp@{Syringenator.hpp}!armDispose@{armDispose}}
\index{armDispose@{armDispose}!Syringenator.hpp@{Syringenator.hpp}}
\paragraph{\texorpdfstring{armDispose()}{armDispose()}}
{\footnotesize\ttfamily void arm\+Dispose (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
This routine should attempt to close the claw completely and detect if an object as actually been grabbed. parameters should be bytes because they will have to be transmitted over serial from the pi. Ranges on these values T\+BD as convenient for the arm software, but must be recorded in the system constants file.
...
--A\+BD \mbox{\Hypertarget{Syringenator_8hpp_a329dc12ddbc9d24c02724b380a041b04}\label{Syringenator_8hpp_a329dc12ddbc9d24c02724b380a041b04}} 
...
--A\+BD \mbox{\Hypertarget{Syringenator_8hpp_a794c6d938a2f3689c46955eddb7bc93f}\label{Syringenator_8hpp_a794c6d938a2f3689c46955eddb7bc93f}} 
\index{Syringenator.hpp@{Syringenator.hpp}!serialCommunication\_ISR@{serialCommunication\_ISR}}
\index{serialCommunication\_ISR@{serialCommunication\_ISR}!Syringenator.hpp@{Syringenator.hpp}}
\paragraph{\texorpdfstring{serialCommunication\_ISR()}{serialCommunication\_ISR()}}
{\footnotesize\ttfamily void serial\+Communication\+\_\+\+I\+SR (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
