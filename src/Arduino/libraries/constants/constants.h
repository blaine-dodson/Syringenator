...
#define PICKUP_X_MIN 270 ///< The minimum target center x-value that allows a pickup
#define PICKUP_X_MAX 395 ///< The maximum target center x-value that allows a pickup
